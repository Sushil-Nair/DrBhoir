...
const MetadataManager = ({
  ...
  address = {
    streetAddress: 'Dr. Bhoir Farm & Resort, 56/3 B Dahagaon-Manjarli Road, Rayate',
  ...
  {
    question: 'Is Dr. Bhoir Farm & Resort suitable for families with children?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Check-in time: 11:00 AM and Check-out time: 10:00 AM',
  },
  {
  ...
  {
    question: 'How do I book a stay or day outing at Dr. Bhoir Farm & Resort?',
    answer:
  ...
  const absoluteOgImage = ogImage.startsWith('http') ? ogImage : `${SITE_URL}${ogImage.replace(/^\./, '')}`;
