             ...
             <div className="text-center text-white px-4">
                 ...
                 <div className='flex gap-4 justify-center items-center'>
                  <div className='group relative'>
                     <NavLink
                         to="/about"
                         className="inline-flex cursor-pointer items-center bg-gray-950/30 border-2 border-cta text-white font-bold px-6 py-3 rounded-lg hover:bg-cta transition-transform duration-300 group-hover:scale-105">
                         Know More
