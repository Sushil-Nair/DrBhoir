...
export default function GallerySightseeing() {
  return (
    <div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-4 py-8">
            <div className="relative h-full flex items-center justify-center">
                <h1 className="text-xl md:text-2xl font-semibold text-black mb-4 scale-up-center">Sightseeing</h1>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
              {gallerySightseeing.map((image, index) => (
