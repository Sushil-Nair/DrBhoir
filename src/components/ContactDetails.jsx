  ...
  return (
    <div className=' flex flex-col w-full mx-auto px-4 sm:px-6 lg:px-8 bg-primary gap-4'>
       <h3 className="text-2xl font-semibold text-center text-black mb-5">Find Us <span className='text-cta'>Here</span></h3>
        ...
        <div className='flex items-center justify-between p-8 bg-[#499bb6] text-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300'>
          <p className='font-bold text-xl'>Discover Your Retreat Destination</p>
          <button className="flex gap-4 items-center text-black font-bold px-6 py-3 rounded-full bg-white hover:bg-[#499bb6] hover:text-white transition-transform duration-300 group-hover:scale-105">
            <FaLocationArrow />
