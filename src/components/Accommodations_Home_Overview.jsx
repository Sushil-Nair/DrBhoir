  ...
  return (
    <div>
        <div className="flex flex-col w-full mx-auto px-4 sm:px-6 lg:px-8 bg-primary pb-16 gap-4">
            <h3 className="text-2xl font-semibold text-center text-black mb-5">Stay in Comfort, Surrounded by <span className='text-cta'>Nature</span></h3>
            <p className="text-lg md:text-xl mb-3">From romantic getaways to group retreats, we offer a variety of accommodations to suit every need. Enjoy comfort, privacy, and stunning views of nature.</p>
