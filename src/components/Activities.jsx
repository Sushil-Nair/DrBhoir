    ...
    <div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="relative h-full flex items-center justify-center">
          <h1 className="text-2xl md:text-3xl font-semibold text-black mb-10 scale-up-center">
            Indulge in Our Activities
          </h1>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-20">
          {activities.map((image, index) => (
            <div
              key={index}
              className="group relative scale-up-center aspect-square"
            >
              <img
                src={image.url}
                alt={image.caption}
