            ...
            <div className="p-8 flex flex-col justify-between scale-up-center">
                 <div className='h-full'>
                    ...
                    <div className='flex flex-col w-full mt-4 group relative gap-10'>
                         <NavLink
                             to="/contact"
                             className="inline-flex items-center mx-auto bg-cta text-white font-bold px-6 py-3 mt-4 rounded-lg hover:bg-green-900 transition-transform duration-300 group-hover:scale-105">
                             Check Availability
