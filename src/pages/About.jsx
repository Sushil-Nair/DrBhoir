  ...
  return (
    <MetadataManager
      ...
      breadcrumbs={[
        ...
        {
          name: "About Us",
          url: "https://drbhoirfarmandresort.com/about",
        },
      ]}
    >
          ...
          >
            <div className="slide-in-left-t">
              ...
              <p className="text-gray-600 mb-4">
                ...
                , your premier destination for a serene and luxurious getaway in
                the heart of the Kalyan - Badlapur region. Our farmhouse resort
                is conveniently accessible from Mumbai, Thane, and Navi Mumbai.
              </p>
            ...
            <div className="scale-up-center order-1 sm:order-2">
              ...
              <ul className="space-y-6">
                {offerings.map((offering) => (
                  <li key={offering.title} className="flex items-start gap-4">
